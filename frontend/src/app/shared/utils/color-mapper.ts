...
export function gradeBg(rank: number): string {
  switch (rank) {
    case 1:
      return 'bg-gradient-to-b from-amber-400 to-amber-100';
    case 2:
      return 'bg-gradient-to-b from-slate-400 to-slate-100';
    case 3:
      return 'bg-gradient-to-b from-orange-400 to-orange-100';
    default:
