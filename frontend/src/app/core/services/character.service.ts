...
export class CharacterService {
  ...
  /** 未登録ウマ娘の一覧を取得する */
  getUnregisteredUmamusumes(): Observable<UmamusumeResponse[]> {
    return this.http.get<UmamusumeResponse[]>(`${environment.apiUrl}/umamusumes/unregistered`);
  }

  /** 登録済みウマ娘の一覧を取得する */
  getRegisteredUmamusumes(): Observable<RegisteredUmamusumeResponse[]> {
    return this.http.get<RegisteredUmamusumeResponse[]>(
      `${environment.apiUrl}/umamusumes/registered`,
    );
  }
